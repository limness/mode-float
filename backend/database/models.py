...
class UavFlightModel(Base):
    ...
    major_region_id: Mapped[int | None] = mapped_column(ForeignKey('regions.id'), nullable=True)
    takeoff_region_id: Mapped[int | None] = mapped_column(ForeignKey('regions.id'), nullable=True)
    landing_region_id: Mapped[int | None] = mapped_column(ForeignKey('regions.id'), nullable=True)
...
class FileMetadataModel(Base):
    ...
    sheet_names: Mapped[list[str] | None] = mapped_column(JSONB, nullable=False)
